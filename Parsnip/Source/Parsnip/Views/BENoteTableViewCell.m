...
@implementation BENoteTableViewCell
{
    BOOL _editing;
...
+ (void)initialize
{
    ...
    preferredHeight = [BEUI.theme floatForKey:themeKey withSubkey:@"Height" withDefault:56.0f];
    padding = [BEUI.theme edgeInsetsForKey:themeKey withSubkey:@"Padding"];
    separatorInset = [BEUI.theme edgeInsetsForKey:themeKey withSubkey:@"SeparatorInset"];

    deleteConfirmationBounceWidth = [BEUI.theme floatForKey:themeKey withSubkey:@"DeleteButtonBounceWidth" withDefault:50.0f];
    deleteConfirmationDragThreshold = [BEUI.theme floatForKey:themeKey withSubkey:@"DeleteButtonDragThreshold" withDefault:0.5f];
    archiveConfirmationDragThreshold = [BEUI.theme floatForKey:themeKey withSubkey:@"ArchiveButtonDragThreshold" withDefault:0.5f];

    textLabelMargin = [BEUI.theme edgeInsetsForKey:themeKey withSubkey:@"Text.Margin"];
    textLabelEmptyText = [BEUI.theme stringForKey:@"Note.EmptyTitle"];

    detailTextLabelMargin = [BEUI.theme edgeInsetsForKey:themeKey withSubkey:@"DetailText.Margin"];
    detailTextLabelNumberOfLines = [BEUI.theme integerForKey:themeKey withSubkey:@"DetailText.NumberOfLines"];

    CGSize thumbnailSize = [BEUI.theme sizeForKey:@"NoteThumbnailSize"];
    ...
    imageViewMargin = [BEUI.theme edgeInsetsForKey:themeKey withSubkey:@"Thumbnail.Margin"];
}
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _contentView.backgroundColor = [BEUI.theme colorForKey:themeKey withSubkey:@"BackgroundColor"];
        ...
        UIColor *textColor = [BEUI.theme colorForKey:themeKey withSubkey:@"TextColor"];
        UIColor *selectedTextColor = [BEUI.theme colorForKey:themeKey withSubkey:@"SelectedTextColor"];

        _textLabel = [[UILabel alloc] init];
        _textLabel.backgroundColor = [BEUI.theme colorForKey:themeKey withSubkey:@"BackgroundColor"];
        _textLabel.textColor = [BEUI.theme colorForKey:themeKey withSubkey:@"Text.TextColor" withDefault:textColor];;
        _textLabel.highlightedTextColor = [BEUI.theme colorForKey:themeKey withSubkey:@"Text.SelectedTextColor" withDefault:selectedTextColor];
        _textLabel.textAlignment = NSTextAlignmentLeft;
        _textLabel.font = [BEUI.theme fontForKey:themeKey withSubkey:@"Text.Font"];
        _textLabel.numberOfLines = 1;

        _detailTextLabel = [[UILabel alloc] init];
        _detailTextLabel.backgroundColor = [BEUI.theme colorForKey:themeKey withSubkey:@"BackgroundColor"];
        _detailTextLabel.textColor = [BEUI.theme colorForKey:themeKey withSubkey:@"DetailText.TextColor" withDefault:textColor];
        _detailTextLabel.highlightedTextColor = [BEUI.theme colorForKey:themeKey withSubkey:@"DetailText.SelectedTextColor" withDefault:selectedTextColor];
        _detailTextLabel.textAlignment = NSTextAlignmentLeft;
        _detailTextLabel.font = [BEUI.theme fontForKey:themeKey withSubkey:@"DetailText.Font"];
        _detailTextLabel.numberOfLines = detailTextLabelNumberOfLines;

        _archiveButton = [BEUI buttonWithKey:@"NoteTableCell.ArchiveButton" target:nil action:nil];
        _archiveButton.hidden = YES;

        _deleteButton = [BEUI buttonWithKey:@"NoteTableCell.DeleteButton" target:self action:@selector(onDeleteButton)];
...
- (void)setHighlighted:(BOOL)highlighted animated:(BOOL)animated
{
    if (!self.showingControls) {
        ...
        if(highlighted) {
            [self setBackgroundColor:[BEUI.theme colorForKey:themeKey withSubkey:@"SelectedBackgroundColor"] animated:animated];
        } else {
            [self setBackgroundColor:[BEUI.theme colorForKey:themeKey withSubkey:@"BackgroundColor"] animated:animated];
        }
    }
}
