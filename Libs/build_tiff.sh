...
#setenv_arm6
#./configure --host=arm-apple-darwin6 --enable-shared=no --disable-programs --disable-jpeg
#make -j4
#cp -rvf libtiff/.libs/lib*.a $LOCAL_OUTDIR/arm6

make clean 2> /dev/null
make distclean 2> /dev/null
setenv_arm7
./configure --host=arm-apple-darwin7 --enable-shared=no --disable-programs --disable-jpeg
make -j4
cp -rvf libtiff/.libs/lib*.a $LOCAL_OUTDIR/arm7
...
./configure --host=arm-apple-darwin7 --enable-shared=no --disable-programs --disable-jpeg
make -j4
cp -rvf libtiff/.libs/lib*.a $LOCAL_OUTDIR/arm7s
...
./configure --host=arm-apple-darwin7 --enable-shared=no --disable-programs --disable-jpeg
make -j4
cp -rvf libtiff/.libs/lib*.a $LOCAL_OUTDIR/arm64

make clean 2> /dev/null
make distclean 2> /dev/null
setenv_i386
./configure --enable-shared=no --disable-programs --disable-jpeg
make -j4
cp -rvf libtiff/.libs/lib*.a $LOCAL_OUTDIR/i386
