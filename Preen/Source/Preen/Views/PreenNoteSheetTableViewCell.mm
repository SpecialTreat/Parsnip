...
@implementation PreenNoteSheetTableViewCell
{
...
+ (void)initialize
{
    ...
    accessoryMargin = [PreenUI.theme edgeInsetsForKey:@"TableCellAccessory.Margin"];
    buttonMargin = [PreenUI.theme edgeInsetsForKey:@"NoteSheetTableCellButton.Margin"];
    buttonWidth = [PreenUI.theme floatForKey:@"NoteSheetTableCellButton.Width"];
    cellPadding = [PreenUI.theme edgeInsetsForKey:themeKey withSubkey:@"Padding"];
    textMargin = [PreenUI.theme edgeInsetsForKey:themeKey withSubkey:@"Text.Margin"];
}
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.accessoryView = [[UIImageView alloc] initWithImage:[PreenUI.theme imageForKey:@"TableCellAccessory.Image"]
                                               highlightedImage:[PreenUI.theme imageForKey:@"TableCellAccessory.SelectedImage"]];

        self.backgroundColor = [PreenUI.theme colorForKey:themeKey withSubkey:@"BackgroundColor"];
        ...
        self.selectedBackgroundView.backgroundColor = [PreenUI.theme colorForKey:themeKey withSubkey:@"SelectedBackgroundColor"];

        textLabel = [[UILabel alloc] init];
        textLabel.backgroundColor = [PreenUI.theme colorForKey:themeKey withSubkey:@"BackgroundColor"];
        textLabel.textColor = [PreenUI.theme colorForKey:themeKey withSubkey:@"TextColor"];
        textLabel.highlightedTextColor = [PreenUI.theme colorForKey:themeKey withSubkey:@"SelectedTextColor"];
...
- (void)setText:(NSString *)text
{
    ...
    if([text rangeOfCharacterFromSet:[NSCharacterSet newlineCharacterSet]].location == NSNotFound) {
        ...
        textLabel.font = [PreenUI.theme fontForKey:themeKey withSubkey:@"Font"];
    } else {
        ...
        if(numberOfLines > 2) {
            textLabel.font = [PreenUI.theme fontForKey:themeKey withSubkey:@"SmallFont"];
        } else {
            textLabel.font = [PreenUI.theme fontForKey:themeKey withSubkey:@"Font"];
        }
    }
...
- (void)addButtonWithKey:(NSString *)key
                  ...
                  action:(SEL)selector
{
    UIButton *button = [PreenUI buttonWithKey:@[key, @"NoteSheetTableCellButton"] target:target action:selector];
