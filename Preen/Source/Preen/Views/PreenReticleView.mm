...
@implementation PreenReticleView
{
    UIView *topMask;
    UIView *leftMask;
    UIView *rightMask;
    ...
    PreenDraggableImageView *topLeft;
    PreenDraggableImageView *topRight;
    PreenDraggableImageView *bottomRight;
    PreenDraggableImageView *bottomLeft;
}
...
- (void)initSubviews
{
    ...
    topLeft = [[PreenDraggableImageView alloc] initWithImage:[UIImage imageNamed:@"HandleTopLeft.png"]];
    topLeft.exclusiveTouch = YES;
    topLeft.delegate = self;
    
    topRight = [[PreenDraggableImageView alloc] initWithImage:[UIImage imageNamed:@"HandleTopRight.png"]];
    topRight.exclusiveTouch = YES;
    topRight.delegate = self;

    bottomLeft = [[PreenDraggableImageView alloc] initWithImage:[UIImage imageNamed:@"HandleBottomLeft.png"]];
    bottomLeft.exclusiveTouch = YES;
    bottomLeft.delegate = self;
    
    bottomRight = [[PreenDraggableImageView alloc] initWithImage:[UIImage imageNamed:@"HandleBottomRight.png"]];
...
- (void)onTopLeftDrag:(PreenDraggableImageView *)view
{
...
- (void)onTopRightDrag:(PreenDraggableImageView *)view
{
...
- (void)onBottomLeftDrag:(PreenDraggableImageView *)view
{
...
- (void)onBottomRightDrag:(PreenDraggableImageView *)view
{
