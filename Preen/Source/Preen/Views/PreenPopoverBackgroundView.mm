...
@implementation PreenPopoverBackgroundViewDefaultContentAppearance
...
@implementation PreenPopoverBackgroundView
{
...
static CGFloat _arrowSlope = _arrowHeight / (_arrowBase / 2.0f);
static UIEdgeInsets _contentViewInsets = UIEdgeInsetsMake(8.0f, 8.0f, 8.0f, 8.0f);
