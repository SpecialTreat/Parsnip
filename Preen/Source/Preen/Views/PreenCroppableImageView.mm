...
@implementation PreenCroppableImageView
{
    PreenReticleView *reticleView;
    PreenZoomableImageView *zoomableView;
}
...
- (void)initSubviews
{
    zoomableView = [[PreenZoomableImageView alloc] initWithFrame:self.bounds];
    ...
    zoomableView.doubleTapZoomMode = PreenZoomModeStep;

    reticleView = [[PreenReticleView alloc] initWithFrame:self.bounds];
