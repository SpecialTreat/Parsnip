...
#import "PreenCroppableImageView.h"
...
@implementation PreenCropController
{
    UIBarButtonItem *okButton;
    PreenCroppableImageView *cropView;
    NSDate *imageDate;
...
+ (void)initialize
{
    cropMaskAlpha = [PreenUI.theme floatForKey:@"Crop.MaskAlpha" withDefault:0.5f];
    cropZoomStep = [PreenUI.theme floatForKey:@"Crop.ZoomStep" withDefault:1.5f];
    cropZoomMargin = [PreenUI.theme floatForKey:@"Crop.ZoomMargin" withDefault:16.0f];
    cropMaximumZoomScale = [PreenUI.theme floatForKey:@"Crop.MaximumZoomScale" withDefault:5.0f];
    cropSymmetrical = [PreenUI.theme boolForKey:@"Crop.Symmetrical" withDefault:NO];
    cropTitle = [PreenUI.theme stringForKey:@"Crop.Title"];
}
...
- (void)viewDidLoad
{
    ...
    cropView = [[PreenCroppableImageView alloc] initWithFrame:frame];
    ...
    okButton = [PreenUI barButtonItemWithKey:@[@"NavigationBarOkButton", @"NavigationBarButton"] target:self action:@selector(onOkButtonTouch)];
