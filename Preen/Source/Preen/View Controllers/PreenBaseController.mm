...
@implementation PreenBaseController
...
- (void)popToRoot
{
    PreenAppDelegate *appDelegate = (PreenAppDelegate *)[[UIApplication sharedApplication] delegate];
...
- (void)presentNavigableViewController:(UIViewController *)viewController
            navigationBarClipsToBounds:(BOOL)navigationBarClipsToBounds
                            ...
                            completion:(void (^)())completion
{
    PreenNavigationController *navigationController = [[PreenNavigationController alloc] initWithRootViewController:viewController];
