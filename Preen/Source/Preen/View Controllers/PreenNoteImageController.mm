...
@implementation PreenNoteImageController
{
    BOOL isNoteRendered;
...
+ (void)initialize
{
    noteImageToolbarHeight = [PreenUI.theme floatForKey:@"NavigationBarBlack.Height"];
    noteImageMaximumZoomScale = [PreenUI.theme floatForKey:@"NoteImage.MaximumZoomScale" withDefault:4.0f];
    noteImageMaskAlpha = [PreenUI.theme floatForKey:@"NoteImage.MaskAlpha" withDefault:0.5f];
    spotlightBorderWidth = [PreenUI.theme floatForKey:@"NoteImage.SpotlightBorderWidth" withDefault:1.0f];
}
...
- (UIStatusBarStyle)preferredStatusBarStyle
{
    if (UIDevice.isIOS7) {
        ...
        return PreenUI.preferredStatusBarStyle;
    }
}
...
- (void)viewDidLoad
{
    ...
    toolbarContainer.backgroundColor = [PreenUI.theme colorForKey:@"NavigationBarBlack.BackgroundColor"];
    ...
    doneButton = [PreenUI barButtonItemWithKey:@[@"NavigationBarBlackDoneButton", @"NavigationBarBlackButton"] target:self action:@selector(onDoneButtonItemTouch)];
    spotlightButton = [PreenUI barButtonItemWithKey:@[@"NavigationBarNormalImageButton", @"NavigationBarBlackButton"] target:self action:@selector(onSpotlightButton)];
    normalButton = [PreenUI barButtonItemWithKey:@[@"NavigationBarOcrImageButton", @"NavigationBarBlackButton"] target:self action:@selector(onNormalButton)];
    ocrButton = [PreenUI barButtonItemWithKey:@[@"NavigationBarSpotlightImageButton", @"NavigationBarBlackButton"] target:self action:@selector(onOcrButton)];
