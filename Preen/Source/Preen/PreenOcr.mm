...
- (NSString *)tryReplacement:(SEL)selector inText:(NSString *)text strict:(BOOL)strict
{
    ...
    NSUInteger preCount = [PreenTextData detectDataTypesCount:text];
    NSUInteger postCount = [PreenTextData detectDataTypesCount:postText];
...
{
    NSArray *states = [[PreenConstants statesAbbr] arrayByAddingObjectsFromArray:[PreenConstants states]];
